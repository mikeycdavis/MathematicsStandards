...
- **Equivalences:** none
- **Evidence:**
  - proof — `proofs/clm-0002.md#no-such-section`
  - proof — `proofs/no-such-file.md`
...
- **Equivalences:** none
- **Evidence:**
  - counterexample-search — exhaustive over all gap-regular sequences with a_1 <= 50 and n <= 10^6, exact integer arithmetic, `computations/density/search.py`, no counterexample found
